...
export type roundState =
  ...
  | "SPECIAL_CASE_4" // SPECIAL CASE  4 FIRST LAP WON -> SECOND LAP WON #FIXME This was special case 5 before
  ...
  //FIXME Special CASE 5 and 4 are the same
  | "TEAM_WON_TWO_LAPS_IN_A_ROW" // SPECIAL CASE  4 FIRST LAP WON -> SECOND LAP WON
